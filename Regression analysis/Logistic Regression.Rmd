...
KIRC_tcga_PID_cluster = rbind(KIRC_tcga, cluster_number_tcga)
rownames(KIRC_tcga_PID_cluster)[rownames(KIRC_tcga_PID_cluster) == "1"] <- "Infiltration"

#get annotations
KIRC_tcga_immunep_annotations = tcga_tumor_annotation %>% filter(sample %in% KIRC_tcga_immune_patients)

#perform immune deconvolution on KIRC TCGA DS2 
