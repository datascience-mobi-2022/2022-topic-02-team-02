...
```{r}
## is tcga_exp_protein_coding now tcga_exp_cleaned???
...
ggplot(tcga_exp_pc_meanvar, aes(tcga_exp_pc_mean, tcga_exp_pc_var, color = 'Average-high variance genes')) + #first layer black points
  ...
  scale_color_manual(name=' ',
                     ...
                     values=c('Very high variance genes'='blue', 'Average-high variance genes'='black', 'Low variance genes'='orange')) + guides(colour = guide_legend(override.aes = list(size = 5))) #try to get bigger legend points
```
