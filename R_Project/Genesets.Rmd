...
#print jaccard value getJaccard()
#teste nun mit geneOverlapMatrix funktion für alle genesets
go.matrix = newGOM(first_23, last_23)
drawHeatmap(go.matrix, what="Jaccard",ncolused=5) #problem: "figure margins too large"
j = as.data.frame(unlist(go.matrix@go.nested.list))
go.matrix@go.nested.list@Jaccard
...
```{r}
geneset.matrix = as.matrix(genesets[["genesets"]])
