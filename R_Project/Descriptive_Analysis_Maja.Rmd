...
# 1)removed low variance genes in grey by creating dataframe 
...
tcga_exp_high_var = tcga_exp_var[tcga_exp_var > 45]
...
#plot
ggplot(tcga_exp_meanvar, aes(tcga_exp_mean, tcga_exp_var)) + geom_point(shape = ".",alpha=0.35) + geom_point(data = tcga_exp_low_meanvar, aes(tcga_exp_low_mean, tcga_exp_low_var), color = "blue", shape = ".", alpha=0.35)  + geom_point(data = tcga_exp_high_meanvar, aes(mean_for_high_var, tcga_exp_high_var), color = "orange", size = 0.3)
```
