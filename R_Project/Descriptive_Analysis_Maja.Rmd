...
ggplot(tcga_exp_pc_meanvar, aes(tcga_exp_pc_mean, tcga_exp_pc_var, color = 'Average-high variance genes')) + #first layer black points
  ...
  scale_color_manual(name=' ',
                     ...
                     values=c('Low variance genes'='blue', 'Average-high variance genes'='black', 'Very high variance genes'='orange')) + #legend
  guides(color = guide_legend(override.aes = list(size = 5))) #try to get bigger legend points
```
