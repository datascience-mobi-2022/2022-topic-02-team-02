...
Infiltrated = Immune_ready[which(Immune_ready$Immunetype == "Immune infiltrated"),]
Infiltrated_sum = sum(Infiltrated$Ratio)
Suppresive = Immune_ready[which(Immune_ready$Immunetype == "Not immune infiltrated"),]
Suppresive_sum = sum(Suppresive$Ratio)

pie_prep = data.frame(c(Neutral_sum,Infiltrated_sum,Suppresive_sum),c("Neutral","Infiltrated","Not infiltrated"))
