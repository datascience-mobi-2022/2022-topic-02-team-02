...
kirci = Heatmap(sig_patient1_order, col = col_fun,show_heatmap_legend = F, column_title = "Cluster 1",column_title_gp = gpar(fontsize = 16, fontface ="bold"),cluster_rows = F, cluster_columns = F, column_names_gp = grid::gpar(fontsize = 0))+ Heatmap(sig_patient2_order, column_title_gp = gpar(fontsize = 16, fontface ="bold"),col = col_fun,heatmap_legend_param = list(title= "NES"),column_title = "Cluster 2", cluster_rows = F,cluster_columns = F,column_names_gp = grid::gpar(fontsize = 0)) +Heatmap(sig_patient3_order, col = col_fun, show_heatmap_legend = F,column_title = "Cluster 3",column_title_gp = gpar(fontsize = 16, fontface ="bold"), cluster_rows = F,cluster_columns = F,column_names_gp = grid::gpar(fontsize = 0))
