...
Packages that have been used are listed in Appendix (see Table 6.1) <!-- Results -->
\clearpage
...
\end{figure}
```
By taking the exponent of the coefficients in Table 3.1, the returned value implies that for every increase of $1$ in  `NES` of the TCR and the IL-1 pathway, the odds-ratio for a patient being immune infiltrated increases by the factor $2.64517$($164.5\%$) and $3.206149$  ($220.6\%$), respectively.
