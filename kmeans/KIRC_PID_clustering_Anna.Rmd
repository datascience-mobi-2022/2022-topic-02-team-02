...
ggplot (data =KIRC_PID_UMAP, 
  ...
  labs(x = "UMAP1", y = "UMAP2", col = "Tumor stage", title = )+
  geom_point(size = 1.3)
...
color_fun = circlize::colorRamp2(c(common_min,0,common_max), c("blue", "red"))
...
Seurat_PID = FindClusters(Seurat_PID, n.start = 20, n.iter = 50, resolution = 0.3) #"Identify clusters of cells by a shared nearest neighbor (SNN) modularity optimization based clustering algorithm. First calculate k-nearest neighbors and construct the SNN graph. Then optimize the modularity function to determine clusters."
...
#cluster_rows = FALSE, column_names_gp = gpar(fontsize = 2), row_names_gp = gpar(fontsize = 10),width = ncol(quantiseq_matrix)*unit(0.45, “mm”), height = nrow(quantiseq_matrix)*unit(10, “mm”), column_dend_height = unit(15, “mm”), column_title = “Immune cell fractions in KIRC TCGA”
```
...
Heatmap(PID_c1_sig_ordered, column_title = "Cluster 1", column_title_gp = gpar(fontsize = 10),col = col_fun1,cluster_rows = FALSE, cluster_columns =  F,column_names_gp = gpar(fontsize = 6),row_names_gp = gpar(fontsize = 8),heatmap_legend_param = list(title = "NES",title_gp = gpar(fontsize = 7),labels_gp = gpar(fontsize = 7)))+
  Heatmap(PID_c2_sig_ordered, column_title = "Cluster 2", column_title_gp = gpar(fontsize = 10),col = col_fun1,cluster_rows = FALSE, cluster_columns =  F,column_names_gp = gpar(fontsize = 6),row_names_gp = gpar(fontsize = 8),show_heatmap_legend = FALSE) 
```
