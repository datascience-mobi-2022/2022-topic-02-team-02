...
PIDClusterHeatmap = Heatmap(PID_all_sig_ordered, name = "PID_all_sig_ordered", column_km = 2, cluster_rows = FALSE, column_names_gp = gpar(fontsize = 4),row_names_gp = gpar(fontsize = 10), col = colorRamp2(c(-2, 0, 2.5), c("blue", "black", "red")), heatmap_legend_param = list(title= "NES"))
