...
alpha_KEGG=0.05/(nrow(KEGG_1_wilcox_pv))#0.0001157407
...
#Bonferroni-Korrektur
alpha_KEGG=0.05/(nrow(KEGG_2_wilcox_pv))#0.0001157407
#how many pathways have sign different NES??
length(which(KEGG_2_wilcox_pv<alpha_KEGG))#66
...
#Bonferroni-Korrektur
alpha_KEGG=0.05/(nrow(KEGG_3_wilcox_pv))#0.0001157407
#how many pathways have sign different NES??
...
#compare PID clusters and KEGG clusters


```{r get the variables for PID}
#the same code as for PID clustering, just to get all the variables 
#Load data
tcga_tumor_norm = readRDS("~/GitHub/2022-topic-02-team-02/data/tcga_tumor_normal_datascience_proj_2022.RDS")
KIRC_annot = data.frame(tcga_tumor_norm[["KIRC"]][["clinical"]]) #annotation
...
Heatmap(KEGG_c1_H_top25_ordered, column_title = "Cluster 1", column_title_gp = gpar(fontsize = 10),col = col_fun,cluster_rows = FALSE, cluster_columns =  F,column_names_gp = gpar(fontsize = 6),row_names_gp = gpar(fontsize = 6),heatmap_legend_param = list(title = "NES",title_gp = gpar(fontsize = 7),labels_gp = gpar(fontsize = 7)))+
  Heatmap(KEGG_c2_H_top25_ordered, column_title = "Cluster 2", column_title_gp = gpar(fontsize = 10),col = col_fun,cluster_rows = FALSE, cluster_columns =  F,column_names_gp = gpar(fontsize = 6),row_names_gp = gpar(fontsize = 6),show_heatmap_legend = FALSE) +
  Heatmap(KEGG_c3_H_top25_ordered,column_title = "Cluster 3", column_title_gp = gpar(fontsize = 10), col = col_fun,cluster_rows = FALSE,cluster_columns =  F, column_names_gp = gpar(fontsize = 6),row_names_gp = gpar(fontsize = 6),show_heatmap_legend = FALSE)
