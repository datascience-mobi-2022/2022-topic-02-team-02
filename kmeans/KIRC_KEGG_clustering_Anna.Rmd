...
KIRC_KEGG_kmeans = sapply(2:5, function(k){
  kmeans(x = KIRC_KEGG_UMAP , centers = k, nstart = 50 )})
...
KIRC_KEGG_kmeans_tw = sapply(1:5, function(k){
  kmeans(x = KIRC_KEGG_UMAP , centers = k, nstart = 50 )$tot.withinss})
...
KIRC_KEGG_kmeans_c = sapply(2:7, function(k){
  kmeans(x = KIRC_KEGG_UMAP , centers = k, nstart = 50 )$cluster})
...
library(factoextra)
#for 2 centers
km.2 = kmeans(KIRC_KEGG_UMAP, centers = 2, nstart = 200)
...
# for 3 centers
km.3 = kmeans(KIRC_KEGG_UMAP, centers = 3, nstart = 50)
...
# for 4 centers
km.4 = kmeans(KIRC_KEGG_UMAP, centers = 4, nstart = 50)
...
KEGG_km3 =kmeans(KIRC_KEGG_UMAP, 3 ,nstart = 50)
