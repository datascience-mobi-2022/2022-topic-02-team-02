...
```{r}
W = cbind(KEGG_c1_H_top25_ordered,KEGG_c2_H_top25_ordered,KEGG_c3_H_top25_ordered)
ClusterHeatmap = Heatmap(W, name = "PID_all_sig_ordered", column_km = 3, cluster_rows = T, column_names_gp = gpar(fontsize = 7),row_names_gp = gpar(fontsize = 10), heatmap_legend_param = list(title= "NES"))
