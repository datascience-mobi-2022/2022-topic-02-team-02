...
Heatmap(KIRC_GSEA_activity, name = "mat", column_names_gp = gpar(fontsize = 5), row_names_gp = gpar(fontsize = 1.5)
, col = col_fun, heatmap_legend_param = list(title = "NES", title_gp = gpar(fontsize = 7)), column_title = "NES for KIRC DS", column_title_gp = gpar(fontsize = 9),show_row_names = F,show_row_dend = F)
...
Heatmap(KIRC_GSEA_activity_PID, name = "mat", column_names_gp = gpar(fontsize = 5), row_names_gp = gpar(fontsize = 5),col = col_fun,heatmap_legend_param = list(title = "NES", title_gp = gpar(fontsize = 7)),column_title = "NES PID genesets for KIRC DS", column_title_gp = gpar(fontsize = 9),show_row_names = F, show_row_dend = F)
...
Heatmap(KIRC_GSEA_activity_KEGG1, name = "mat", column_names_gp = gpar(fontsize = 5), row_names_gp = gpar(fontsize = 5),col = col_fun,heatmap_legend_param = list(title = "NES", title_gp = gpar(fontsize = 7)),column_title = "NES KEGG genesets for KIRC DS", column_title_gp = gpar(fontsize = 9),show_row_names = F, show_row_dend = F)

Heatmap(KIRC_GSEA_activity_hallmark, name = "mat", column_names_gp = gpar(fontsize = 5), row_names_gp = gpar(fontsize = 6),col = col_fun, row_split = 3,column_split = 2,
 row_gap = unit(c(0,0), "mm"),column_gap = unit(c(0,0), "mm"),heatmap_legend_param = list(title = "NES", title_gp = gpar(fontsize = 7)),column_title = "NES Hallmark genesets for KIRC DS", column_title_gp = gpar(fontsize = 9))
