...
KIRC_GSEA_activity = rbind(KIRC_GSEA_NES_H2,KIRC_GSEA_NES_KEGG)
KIRC_GSEA_pathways = c(pathway_names_H,pathway_names_KEGG)
dim(KIRC_GSEA_activity)
View(KIRC_GSEA_pathways)
