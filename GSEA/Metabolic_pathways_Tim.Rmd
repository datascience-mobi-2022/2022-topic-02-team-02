...
, col = col_fun, heatmap_legend_param = list(title = "NES",title_gp = gpar(fontsize = 14, fontface = "bold")), column_title = "NES for KIRC DS", column_title_gp = gpar(fontsize = 0),show_row_names = F,show_row_dend = F)
...
, title_gp = gpar(fontsize = 14, fontface = "bold")),column_title = "NES PID genesets for KIRC DS", column_title_gp = gpar(fontsize = 9),show_row_names = F, show_row_dend = F,show_column_names = F)
...
, title_gp = gpar(fontsize = 14, fontface = "bold")),column_title = "NES KEGG genesets for KIRC DS", column_title_gp = gpar(fontsize = 0),show_row_names = F, show_row_dend = F,show_column_names = F)
...
, title_gp = gpar(fontsize = 14, fontface = "bold")),column_title = "NES Hallmark genesets for KIRC DS", column_title_gp = gpar(fontsize = 0),show_column_names = F,width = 50*unit(5.2, "mm"))
