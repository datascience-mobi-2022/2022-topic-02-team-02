...
Heatmap(KIRC_GSEA_activity_hallmark, name = "mat", column_names_gp = gpar(fontsize = 5), row_names_gp = gpar(fontsize = 6),col = col_fun, row_split = 3,
 row_gap = unit(c(2,2), "mm"),heatmap_legend_param = list(title = "NES", title_gp = gpar(fontsize = 7)),column_title = "NES Hallmark genesets for KIRC DS", column_title_gp = gpar(fontsize = 9))
