...
Heatmap(KIRC_GSEA_activity, name = "mat", column_names_gp = gpar(fontsize = 5), row_names_gp = gpar(fontsize = 1.5), column_split = 2, row_split = 3,row_gap = unit(c(2,2), "mm"),
 column_gap = unit(c(2,2), "mm"), col = col_fun)
...
Heatmap(KIRC_GSEA_activity_KEGG1, name = "mat", column_names_gp = gpar(fontsize = 5), row_names_gp = gpar(fontsize = 5),col = col_fun, column_km = 3,column_gap = unit(c(2,2), "mm"))
