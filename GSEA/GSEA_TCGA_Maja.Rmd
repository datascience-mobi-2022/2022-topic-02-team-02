...
#melt Hallmark, KEGG, PID and MMR pathway activity matrices
pathway_activity_matrix = rbind(NES_mean, NES_mean_KEGG, NES_mean_PID, NES_mean_MMR)
#heatmap
NES_matrix_ALLE = as.matrix(pathway_activity_matrix)
...
ACC_ordered = pathway_activity_matrix[,1, drop = FALSE]
...
# select top 15 UP and DOWN regulated pathways for ACC
KIRC_ordered = pathway_activity_matrix[,12, drop = FALSE]
...
KEGG_O_GLYCAN_BIOSYNTHESIS = t(pathway_activity_matrix[rownames(pathway_activity_matrix) == "KEGG_O_GLYCAN_BIOSYNTHESIS",, drop = FALSE])
