...
#hier wurde ab 2. spalte gewählt da vorher column 1 rownames waren 
...
```{r}
#probe mit PID new independent gene set 
...
names(PVALUES_OVERALL_PID) = tumornames
names(NES_OVERALL_PID) = tumornames
```
