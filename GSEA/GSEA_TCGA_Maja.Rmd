...
#heatmap 1
Heatmap_NES_hallmark = Heatmap(NES_matrix_hallmark, name = "NES", cluster_rows = TRUE, row_dend_width = unit(0, "cm"), column_split = 4, column_names_gp = gpar(fontsize = 10), row_names_gp = gpar(fontsize = 7), width = ncol(NES_matrix_hallmark)*unit(7, "mm"), height = nrow(NES_matrix_hallmark)*unit(3, "mm"), column_dend_height = unit(15, "mm"), column_title = "Mean NES TCGA Hallmark gene sets", show_heatmap_legend = TRUE)
...
Heatmap_NES_KEGG = Heatmap(NES_matrix_KEGG, name = "NES", cluster_rows = FALSE, column_split = 4, column_names_gp = gpar(fontsize = 10), row_names_gp = gpar(fontsize = 2), width = ncol(NES_matrix_KEGG)*unit(8, "mm"), height = nrow(NES_matrix_KEGG)*unit(1, "mm"), column_dend_height = unit(15, "mm"), column_title = "Mean NES TCGA KEGG gene sets")
Heatmap_NES_KEGG
...
#plot mean NES
Heatmap_NES_PID = Heatmap(NES_matrix_PID, name = "NES", cluster_rows = FALSE, column_split = 5, column_names_gp = gpar(fontsize = 10), row_names_gp = gpar(fontsize = 4), width = ncol(NES_matrix_PID)*unit(8, "mm"), height = nrow(NES_matrix_PID)*unit(2, "mm"), column_dend_height = unit(15, "mm"), column_title = "Mean NES TCGA PID gene sets")
Heatmap_NES_PID
...
Heatmap_NES_PENG = Heatmap(NES_matrix_PENG, name = "NES", cluster_rows = FALSE, column_split = 7, column_names_gp = gpar(fontsize = 10), row_names_gp = gpar(fontsize = 10), width = ncol(NES_matrix_PENG)*unit(8, "mm"), height = nrow(NES_matrix_PENG)*unit(14, "mm"), column_dend_height = unit(15, "mm"), column_title = "Mean NES TCGA PENG gene sets")
Heatmap_NES_PENG
...
Heatmap_TopVar_pw = Heatmap(top_var_pw_matrix, name = "NES", cluster_rows = FALSE, column_split = 6, column_names_gp = gpar(fontsize = 10), row_names_gp = gpar(fontsize = 6), width = ncol(NES_matrix_MMR)*unit(8, "mm"), height = nrow(NES_matrix_MMR)*unit(25, "mm"), column_dend_height = unit(15, "mm"), column_title = "Top 30 variance pathways TCGA")
Heatmap_TopVar_pw
