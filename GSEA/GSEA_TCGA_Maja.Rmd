...
Heatmap_NES_PENG = Heatmap(NES_matrix_PENG, name = "NES", cluster_rows = TRUE, row_dend_width = unit(0, "cm"), column_split = 7, column_names_gp = gpar(fontsize = 10), row_names_gp = gpar(fontsize = 10), width = ncol(NES_matrix_PENG)*unit(8, "mm"), height = nrow(NES_matrix_PENG)*unit(14, "mm"), column_dend_height = unit(15, "mm"), column_title = "Mean NES TCGA PENG gene sets", col = colorRamp2(c(-0.1, 0, 0.1), c("blue", "black", "red")))
Heatmap_NES_PENG
...
Heatmap_TopVar_pw = Heatmap(top_var_pw_matrix, name = "NES", cluster_rows = TRUE, row_dend_width = unit(0, "cm"), column_split = 6, column_names_gp = gpar(fontsize = 10), row_names_gp = gpar(fontsize = 6), width = ncol(NES_matrix_MMR)*unit(8, "mm"), height = nrow(NES_matrix_MMR)*unit(25, "mm"), column_dend_height = unit(15, "mm"), column_title = "Top 30 variance pathways TCGA", col = colorRamp2(c(-0.2, 0, 0.2), c("blue", "black", "red")))
Heatmap_TopVar_pw
