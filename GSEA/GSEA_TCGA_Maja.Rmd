...
#heatmap 1, matrix is matrix von NES_mean
Heatmap_NES_hallmark = Heatmap(NES_matrix_hallmark, name = "NES", cluster_rows = FALSE, column_km = 4, column_names_gp = gpar(fontsize = 10), row_names_gp = gpar(fontsize = 7), width = ncol(NES_matrix_hallmark)*unit(8, "mm"), height = nrow(NES_matrix_hallmark)*unit(3, "mm"), column_dend_height = unit(15, "mm"), column_title = "Mean NES TCGA Hallmark gene sets", show_heatmap_legend = FALSE)
...
Heatmap_NES_KEGG = Heatmap(NES_matrix_KEGG, name = "NES", cluster_rows = FALSE, column_km = 5, column_names_gp = gpar(fontsize = 10), row_names_gp = gpar(fontsize = 2), width = ncol(NES_matrix_KEGG)*unit(8, "mm"), height = nrow(NES_matrix_KEGG)*unit(1, "mm"), column_dend_height = unit(15, "mm"), column_title = "Mean NES TCGA KEGG gene sets")
Heatmap_NES_KEGG
...
Heatmap_NES_PID = Heatmap(NES_matrix_PID, name = "NES", cluster_rows = FALSE, column_km = 5, column_names_gp = gpar(fontsize = 10), row_names_gp = gpar(fontsize = 4), width = ncol(NES_matrix_PID)*unit(8, "mm"), height = nrow(NES_matrix_PID)*unit(2, "mm"), column_dend_height = unit(15, "mm"), column_title = "Mean NES TCGA PID gene sets")
Heatmap_NES_PID
...
Heatmap_NES_MMR = Heatmap(NES_matrix_MMR, name = "NES", cluster_rows = FALSE, column_km = 4, column_names_gp = gpar(fontsize = 10), row_names_gp = gpar(fontsize = 10), width = ncol(NES_matrix_MMR)*unit(8, "mm"), height = nrow(NES_matrix_MMR)*unit(14, "mm"), column_dend_height = unit(15, "mm"), column_title = "Mean NES TCGA MMR gene sets")
Heatmap_NES_MMR
...
Heatmap_NES_PENG = Heatmap(NES_matrix_PENG, name = "NES", cluster_rows = FALSE, column_km = 4, column_names_gp = gpar(fontsize = 10), row_names_gp = gpar(fontsize = 10), width = ncol(NES_matrix_PENG)*unit(8, "mm"), height = nrow(NES_matrix_PENG)*unit(14, "mm"), column_dend_height = unit(15, "mm"), column_title = "Mean NES TCGA PENG gene sets")
Heatmap_NES_PENG
...
```{r tried to plot heatmaps in panel}
#combine all pathway heatmaps?
Heatmap_list_pathways = list(Heatmap_NES_hallmark, Heatmap_NES_KEGG, Heatmap_NES_PID, Heatmap_NES_MMR)

library(gridExtra)
grid.arrange(Heatmap_NES_hallmark, Heatmap_NES_KEGG, Heatmap_NES_PID, Heatmap_NES_MMR, nrow = 2)

pushViewport(viewport(layout = grid.layout(2, 2)))
vplayout <- function(x, y) viewport(layout.pos.row = x, layout.pos.col = y)
print(Heatmap_NES_hallmark, vp = vplayout(1, 1))
print(Heatmap_NES_KEGG, vp = vplayout(1, 2))
print(Heatmap_NES_PID, vp = vplayout(2, 1))
print(Heatmap_NES_MMR, vp = vplayout(2, 2))

plot_grid(Heatmap_NES_hallmark, Heatmap_NES_KEGG, Heatmap_NES_PID, Heatmap_NES_MMR)
panel = rbind(Heatmap_NES_hallmark, Heatmap_NES_KEGG)
panel
...
draw(Heatmap_NES_hallmark, newpage = FALSE)
upViewport()
...
draw(Heatmap(Heatmap_NES_KEGG), newpage = FALSE)
popViewport()
...
figure1 <- multi_panel_figure(
  ...
  columns = 2, rows = 2)
figure1 %<>% fill_panel("../data/Heatmap_PID.png",
  column = 2,
  row = 1)
figure1

figure1 %<>% fill_panel(Heatmap_NES_hallmark, column = 1, row = 1)
figure1 %<>% fill_panel(Heatmap_NES_KEGG, column = 2, row = 1)
figure1 %<>% fill_panel(Heatmap_NES_PID, column = 1, row = 2)
figure1 %<>% fill_panel(Heatmap_NES_PENG, column = 2, row = 2)
figure1

figure2 = multi_panel_figure(width = c(1000, 1000),height = c(1000, 1000))
figure2 %<>% fill_panel(Heatmap_NES_hallmark, column = 1, row = 1)
figure2 %<>% fill_panel(Heatmap_NES_KEGG, column = 2, row = 1)
figure2 %<>% fill_panel(Heatmap_NES_PID, column = 1, row = 2)
figure2 %<>% fill_panel(Heatmap_NES_PENG, column = 2, row = 2)
figure2
...
pathway_activity_matrix_mean = rbind(NES_mean, NES_mean_KEGG, NES_mean_PID_cl, NES_mean_MMR) #ACHTUNG mit altem PID noch
...
Heatmap(NES_matrix_ALLE, name = "mat", column_km = 7, column_names_gp = gpar(fontsize = 5), row_names_gp = gpar(fontsize = 2))
...
Heatmap_TopVar_pw = Heatmap(top_var_pw_matrix, name = "NES", cluster_rows = FALSE, column_km = 7, column_names_gp = gpar(fontsize = 10), row_names_gp = gpar(fontsize = 6), width = ncol(NES_matrix_MMR)*unit(8, "mm"), height = nrow(NES_matrix_MMR)*unit(25, "mm"), column_dend_height = unit(15, "mm"), column_title = "Top 30 variance pathways TCGA", col = pal(50))
Heatmap_TopVar_pw
...
#GSEA table plot for KIRC patient 2
...
NES_KIRC = NES_OVERALL_PID_cl[[12]]
NES_KIRC_abs = abs(NES_KIRC)
NES_KIRC_sum = apply(NES_KIRC_abs, 2, sum)
