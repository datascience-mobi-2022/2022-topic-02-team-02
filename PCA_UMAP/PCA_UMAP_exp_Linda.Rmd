...
for (i in 1:4) {
  cancer = c(which(cancer_types == cancer_abc[i]))
  cancer_df = data.frame(UMAP_tumorlist_1_4[[i]])
  UMAP_output_1_4[[i]] = ggplot (data = cancer_df,
  aes (x = X1, y =X2, color = "blue")) + 
...
for (i in 1:26) {
  cancer = c(which(cancer_types == cancer_abc[i]))
  cancer_df = data.frame(UMAP_tumorlist_8_33[[i]])
  UMAP_output_8_33[[i]] = ggplot (data = cancer_df,
  aes (x = X1, y =X2, color = "blue")) + 
    geom_point(size = 0.5 , color = "blue")+ 
